...
export default function OverviewPage() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "jd-match" | "grammar" | "questions">("overview")
  ...
  useEffect(() => {
    ...
    if (!storedJdLink || !storedResumeFileName) {
      router.push("/")
      return
    }
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === "overview" && (
          <>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <Card className="border-blue-200 shadow-lg">
                <CardHeader className="bg-blue-50 text-center">
                  <CardTitle className="text-blue-900">JD Match Score</CardTitle>
                  <CardDescription className="text-blue-700">Resume alignment with job requirements</CardDescription>
                </CardHeader>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-blue-600 mt-2">Strong alignment with job requirements</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-blue-200 shadow-lg">
                <CardHeader className="bg-blue-50 text-center">
                  ...
                  <CardDescription className="text-blue-700">Writing quality and professionalism</CardDescription>
                </CardHeader>
                <CardContent className="p-6 text-center">
                  <div className="relative w-32 h-32 mx-auto mb-4">
                    <svg className="w-32 h-32 transform -rotate-90" viewBox="0 0 36 36">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h4 className="font-medium text-green-900">Matching Keywords</h4>
                          <p className="text-sm text-green-600">Strong alignment found</p>
                        </div>
                      </div>
                      <div className="text-2xl font-bold text-green-700">
                        {matchingKeywords.filter((k) => k.status === "match").length}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h4 className="font-medium text-yellow-900">Partial Matches</h4>
                          <p className="text-sm text-yellow-600">Room for improvement</p>
                        </div>
                      </div>
                      <div className="text-2xl font-bold text-yellow-700">
                        {matchingKeywords.filter((k) => k.status === "partial").length}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg border border-red-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-red-600">Consider adding</p>
                        </div>
                      </div>
                      <div className="text-2xl font-bold text-red-700">
                        {matchingKeywords.filter((k) => k.status === "missing").length}
                      </div>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="text-center p-4 bg-red-50 rounded-lg border border-red-200">
                      <div className="text-2xl font-bold text-red-700">
                        {grammarIssues.filter((issue) => issue.type === "error").length}
                      </div>
                      <div className="text-sm text-red-600">Grammar Errors</div>
                      <div className="text-xs text-red-500 mt-1">Need immediate attention</div>
                    </div>
                    <div className="text-center p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                      <div className="text-2xl font-bold text-yellow-700">
                        {grammarIssues.filter((issue) => issue.type === "warning").length}
                      </div>
                      <div className="text-sm text-yellow-600">Style Warnings</div>
                      <div className="text-xs text-yellow-500 mt-1">Recommended fixes</div>
                    </div>
                    <div className="text-center p-4 bg-blue-50 rounded-lg border border-blue-200">
                      <div className="text-2xl font-bold text-blue-700">
                        {grammarIssues.filter((issue) => issue.type === "suggestion").length}
                      </div>
                      <div className="text-sm text-blue-600">Suggestions</div>
                      <div className="text-xs text-blue-500 mt-1">Enhancement opportunities</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
                      ...
                      <div className="text-2xl font-bold text-green-700">{questions.easy.length}</div>
                    ...
                    <div className="text-center p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                      ...
                      <div className="text-2xl font-bold text-yellow-700">{questions.medium.length}</div>
                    ...
                    <div className="text-center p-4 bg-red-50 rounded-lg border border-red-200">
                      ...
                      <div className="text-2xl font-bold text-red-700">{questions.hard.length}</div>
                      <div className="text-sm text-red-600">Hard Questions</div>
                      <div className="text-xs text-red-500 mt-1">Technical Challenges</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card className="border-blue-200 shadow-lg">
              <CardHeader className="bg-blue-50">
                <CardTitle className="text-blue-900">Key Recommendations</CardTitle>
                <CardDescription className="text-blue-700">
                  Priority actions to improve your resume and interview readiness
                </CardDescription>
              </CardHeader>
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-900">Fix Grammar Errors</h4>
                      <p className="text-blue-700">
                        Address the 2 grammar errors found in your resume to ensure professional presentation.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-900">Add Missing Keywords</h4>
                      <p className="text-blue-700">
                        Include AWS and GraphQL experience to better match job requirements and improve your score.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-900">Practice Interview Questions</h4>
                      <p className="text-blue-700">
                        Review and practice the 5 tailored interview questions to boost your confidence.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <>
            ...
            <Card className="mt-8 border-blue-200 shadow-lg">
              <CardHeader className="bg-blue-50">
                ...
                <CardDescription className="text-blue-700">
                  How to improve your resume for this position
                </CardDescription>
              </CardHeader>
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-900">Add Missing Keywords</h4>
                      <p className="text-blue-700">
                        Consider adding experience with AWS and GraphQL to better match the job requirements.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-900">Strengthen Leadership Experience</h4>
                      <p className="text-blue-700">
                        Expand on your team leadership experience with specific examples and metrics.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-900">Highlight TypeScript Skills</h4>
                      <p className="text-blue-700">
                        Make your TypeScript experience more prominent in your technical skills section.
                      </p>
                    </div>
                  </div>
                </div>
